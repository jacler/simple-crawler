...
public class POItoExcel1 {
    public static void toExcel(List<Content> list) throws FileNotFoundException, IOException{
        ...
        workBook.write(new FileOutputStream(new File("E:\\\\百度搜索.xls")) );
        workBook.close();
